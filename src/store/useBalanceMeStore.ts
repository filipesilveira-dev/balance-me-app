...
// Criação do Store
export const useBalanceMeStore = create<BalanceMeStore>()(
  persist(
    (set) => ({
    ...
    }),
    {
      ...
      name: "balance-me-storage", 
      // O partialize recebe o estado completo e retorna apenas o que deve ser salvo
      partialize: (state) => ({
        items: state.items,
      }),
    },
